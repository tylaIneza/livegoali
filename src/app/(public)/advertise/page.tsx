  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        {stats.map((s) => (
          <div key={s.label} className="rounded-2xl border border-white/8 bg-[#121821] p-4 text-center">
            <div className="w-9 h-9 rounded-xl bg-[#00FF84]/10 flex items-center justify-center mx-auto mb-2">
