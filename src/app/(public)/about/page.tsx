    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-white/8 bg-[#121821] p-6">
          ...
          <p className="text-gray-400 text-sm mb-3">At LiveGoali, we provide:</p>
          ...
          <p className="text-gray-400 text-sm">Our goal is to make football information accessible and easy to follow for fans across the globe.</p>
        </div>
        ...
        <div className="rounded-2xl border border-white/8 bg-[#121821] p-6">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">We strive to provide accurate football information and updates. While we make every effort to keep our data current and reliable, some information may occasionally be delayed, incomplete, or subject to change.</p>
        </div>

        <div className="rounded-2xl border border-white/8 bg-[#121821] p-6">
          <h2 className="text-white font-bold mb-3">Independence</h2>
          <p className="text-gray-400 text-sm leading-relaxed">LiveGoali operates as an independent football information platform. Any trademarks, team names, league names, or logos belong to their respective owners.</p>
        </div>
        ...
        <div className="rounded-2xl border border-[#00FF84]/20 bg-[#00FF84]/5 p-6">
          ...
          <p className="text-gray-400 text-sm mb-4">We welcome feedback, suggestions, and questions from our users.</p>
      ...
      <div className="mt-10 text-center">
        <p className="text-gray-500 text-sm">Thank you for being part of the LiveGoali community.</p>
