...
export function Footer() {
  return (
    <footer className="bg-[#0B0F14] border-t border-white/8">
            ...
            <div className="flex items-center gap-3">
              {[
                ...
                <a
                  key={i}
                  href={href}
                  className="w-9 h-9 rounded-lg bg-[#1F2937] flex items-center justify-center text-gray-400 hover:text-[#00FF84] hover:bg-[#00FF84]/10 transition-all duration-200"
                >
              ...
              <ul className="space-y-2.5">
                {links.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-sm text-gray-400 hover:text-[#00FF84] transition-colors duration-150"
                    >
                      {link.label}
                    </Link>
                  </li>
