...
async function main() {
  ...
  await prisma.news.upsert({
    ...
    create: {
      ...
      excerpt: "LiveGoali launches as the ultimate destination for live football streaming.",
      content: "<p>We are thrilled to announce the launch of LiveGoali, your new home for live football. Watch every match and follow real-time scores.</p><p>Our platform features premium HD streams and real-time match updates.</p>",
      isPublished: true,
      isFeatured: true,
